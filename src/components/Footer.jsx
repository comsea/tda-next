...
export default function Footer(languetteProps) {
    return(
        <div className="w-full flex flex-col justify-center items-center relative">
            <div className="w-full relative py-10 flex items-center">
                ...
                <div className="w-[90%] flex flex-row items-start justify-center space-x-24">
                    ...
                    <div className="flex flex-col items-start space-y-1 text-lg">
                        <Link href="/" className="hover:underline">Réalisations</Link>
                        <Link href="/" className="text-[#BBBBBB] hover:underline">Enseignement</Link>
                        <Link href="/" className="text-[#BBBBBB] hover:underline">Loisir</Link>
                        <Link href="/" className="text-[#BBBBBB] hover:underline">Logement</Link>
                        <Link href="/" className="text-[#BBBBBB] hover:underline">Tertiaire</Link>
                        <Link href="/" className="text-[#BBBBBB] hover:underline">Santé</Link>
                        <Link href="/" className="text-[#BBBBBB] hover:underline">Sécurité</Link>
                    </div>
                    <div className="flex flex-row space-x-6 text-lg">
                        ...
                        <div className="flex flex-col items-start space-y-1">
                            ...
                            <Link href="/"s className="text-[#BBBBBB] hover:underline">Modifier les cookies</Link>
                        </div>
                    </div>
            ...
            <div className="w-full flex flex-col justify-center items-center py-4 text-base font-normal text-[#BBBBBB] space-y-4">
                <div>
