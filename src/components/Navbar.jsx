...
export default function Navbar() {
    ...
    return(
        <>
            <div className="bg-[#242424] top-0 left-0 fixed h-screen w-[10%] flex flex-col text-xl font-semibold justify-center items-center z-10 py-10">
            ...
            <div className={`bg-[#242424] top-0 left-0 h-screen w-[15%] flex flex-col text-xl font-semibold justify-center items-center z-10 py-10 ${isOpen ? 'fixed' : 'hidden'}`}>
                <div className="w-full flex flex-col justify-between items-start h-full pl-10">
                    <div>
                    ...
                    <div className="w-full flex flex-col items-start justify-start space-y-4">
                        ...
                        <div className="w-full flex flex-col justify-start items-start space-y-1">
                            ...
                            <div className="w-full flex flex-col ml-6 justify-start items-start text-lg font-normal text-[#BBBBBB] space-y-1">
                                <Link href="/presentation" onClick={toggleSidebar}>Enseignement</Link>
                                <Link href="/presentation" onClick={toggleSidebar}>Loisir</Link>
                                <Link href="/presentation" onClick={toggleSidebar}>Logement</Link>
                                <Link href="/presentation" onClick={toggleSidebar}>Tertiaire</Link>
                                <Link href="/presentation" onClick={toggleSidebar}>Santé</Link>
                                <Link href="/presentation" onClick={toggleSidebar}>Public</Link>
                            </div>
                        </div>
