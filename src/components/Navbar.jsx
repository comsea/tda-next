...
export default function Navbar() {
    ...
    return(
        <>
            <div className="bg-[#242424] top-0 left-0 fixed lg:h-screen h-[8vh] lg:w-[10%] w-full flex lg:flex-col flex-row text-xl font-semibold justify-center items-center lg:py-10 py-4 z-50">
