            ...
            <div className="w-full flex flex-row items-center justify-center lg:py-12 pt-24">
                <div className="w-[90%] flex flex-col justify-center items-center text-start space-y-4">
                    <div className="lg:text-6xl text-4xl font-bold mb-10 w-full relative">
                        <h1 className="underline decoration-[#DF0624] lg:underline-offset-8 underline-offset-4 lg:decoration-2 decoration-1">POLITIQUE DE CONFIDENTIALITÉ</h1>
                        <p className="absolute text-[#494949] -z-40 lg:ml-12 ml-4 lg:top-8 top-6">POLITIQUE DE CONFIDENTIALITÉ</p>
                    </div>
                    <div class="w-full flex flex-col font-normal lg:py-12 py-6">
                        <p>Mise à jour : 6 Mars 2024</p>

                        <h2 class="lg:text-3xl text-2xl font-bold mt-6 mb-2">1. Consentement</h2>
                        <p>
                        ...
                        <h2 class="lg:text-3xl text-2xl font-bold mt-6 mb-2">2. Quelles Informations Nous Collectons</h2>
                        <p>
                        ...
                        <h2 class="lg:text-3xl text-2xl font-bold mt-6 mb-2">3. Pourquoi Nous Collectons Vos Données</h2>
                        <p>
                        ...
                        <h2 class="lg:text-3xl text-2xl font-bold mt-6 mb-2">4. Comment Nous Obtenons Votre Consentement</h2>
                        <p>
                        ...
                        <h2 class="lg:text-3xl text-2xl font-bold mt-6 mb-2">5. Vos Droits</h2>
                        <p>
                        ...
                        <h2 class="lg:text-3xl text-2xl font-bold mt-6 mb-2">6. Sécurité de Vos Données</h2>
                        <p>
                        ...
                        <h2 class="lg:text-3xl text-2xl font-bold mt-6 mb-2">7. Partage des Informations</h2>
                        <p>
                            Nous ne partageons pas vos données avec des tiers, sauf avec votre consentement ou lorsque la loi l'exige.
                        </p>

                        <h2 class="lg:text-3xl text-2xl font-bold mt-6 mb-2">8. Cookies et Technologies Similaires</h2>
                        <p>
                        ...
                        <h2 class="lg:text-3xl text-2xl font-bold mt-6 mb-2">9. Conservation des Données</h2>
                        <p>
                        ...
                        <h2 class="lg:text-3xl text-2xl font-bold mt-6 mb-2">10. Contact</h2>
                        <p>
                        ...
                        <p>Nom : Maxime MARQUE</p>
                        <p>Adresse : 9 Rue de l'Abattoir, 08000 Charleville-Mézières</p>
                        <p>Courriel : info@tda-archi.com</p>
                    </div>
                </div>
            </div>
        </div>
