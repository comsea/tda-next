    ...
    return(
        <div className="w-[90%] flex flex-col justify-center items-center">
            <div className="w-full flex flex-col items-center justify-center py-12">
                ...
                <div className="w-full flex flex-row justify-start items-start mt-12 relative">
                    <div className="absolute w-full h-full bg-[#242424] -z-20"></div>
                    <div className="w-[30%] p-16 relative">
                        <div className="w-full flex flex-col justify-start items-start space-y-10 text-xl">
                            <h4 className="text-3xl font-semibold">Nos informations</h4>
                    ...
                    <div className="w-[70%] p-16">
                        <div className="w-full flex flex-col justify-start items-start space-y-10">
                            <h4 className="text-3xl font-semibold">Notre formulaire de contact</h4>
                            <form action="" className="w-full text-base space-y-3">
                                <div className="w-full grid grid-cols-2 gap-x-10 gap-y-4">
                                    ...
                                    <div className="flex flex-col w-full justify-start items-start space-y-2 col-span-2">
                                ...
                                <div className="w-full text-xs flex flex-row justify-between items-center">
                ...
                <div className="w-full py-8 flex justify-center items-center">
                    <div className="w-[95%] flex flex-row justify-between items-center">
                        <div className="w-[30%] flex flex-col justify-center items-center space-y-4">
                            <h3 className="text-3xl font-medium">TDA <span className="text-[#DF0624]">-</span> Charleville-Mézières</h3>
                        ...
                        <div className="w-[30%] flex flex-col justify-center items-center space-y-4">
                            <h3 className="text-3xl font-medium">TDA <span className="text-[#DF0624]">-</span> Reims</h3>
                            <div className="text-lg">
                                <p>29 Rue Chanzy,</p>
                                <p>51100 Reims</p>
                            </div>
                        ...
                        <div className="w-[30%] flex flex-col justify-center items-center space-y-4">
                            <h3 className="text-3xl font-medium">TDA <span className="text-[#DF0624]">-</span> Épernay</h3>
                            <div className="text-lg">
